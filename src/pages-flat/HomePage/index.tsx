	...
	return (
		...
		>
			<Section className={cls.pageWrapper}>
				...
				<div>
					Кайдарова Светлана Александровна
					-основатель и руководитель Клуба,
					тульский региональный представитель «Союза женских сил по поддержке гражданских инициатив»,
					национальный агент развития предпринимательства.
				</div>
			</Section>
		</div>
	);
